...
// If/Else Config Panel - Updated with proper labels as per requirements
...
// Simple While Loop Config Panel
...
// Edge Config Panel - Connect two nodes
const EdgeConfigPanel: React.FC<{
  ...
  // Filter out edge nodes from source/target selection
...
const AgentCanvas: React.FC<AgentCanvasProps> = ({
  ...
  // Draw connections based on edge nodes
  ...
  return (
    ...
    >
      ...
      {/* Connection Lines - from edge nodes */}
